    ...
    <div style={{ maxWidth: '900px', margin: '40px auto' }}>
      ...
      <div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
        <div style={{ flex: 1, fontSize: '14px', lineHeight: '1.6', textAlign: 'left' }}>
          ...
          <h3 style={{ marginTop: '30px', color: '#d87d0a', fontWeight: 'bold' }}>Our Mission</h3>
          <p>
          ...
          <h3 style={{ marginTop: '20px', color: '#d87d0a', fontWeight: 'bold' }}>What We Offer</h3>
          <ul>
            <li><strong>Meditation & Yoga Retreats:</strong> Experience a wide range of meditation techniques and yoga practices to deepen your awareness and achieve mental clarity.</li>
            <li><strong>Mindfulness & Spiritual Growth:</strong> Join our spiritual workshops and teachings designed to open your heart and mind, helping you cultivate mindfulness in your daily life.</li>
            <li><strong>Holistic Healing:</strong> We provide a nurturing environment for physical, emotional, and spiritual healing through traditional and natural practices.</li>
            <li><strong>Community & Service:</strong> Be part of a supportive community of like-minded individuals who share a common commitment to personal and spiritual development.</li>
          </ul>

          <h3 style={{ marginTop: '20px', color: '#d87d0a', fontWeight: 'bold' }}>Our Vision</h3>
          <p>
          ...
          <p>
            Join us at Kalinga Ashram, and allow the serenity of our space and the wisdom of our teachings to guide you towards a life of fulfillment and harmony.
          </p>
        </div>
